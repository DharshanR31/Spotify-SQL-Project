...
FROM artist AS a
JOIN album2 AS albm ON albm.artist_id = a.artist_id
...
JOIN album2 AS albm2 ON t.album_id = albm2.album_id
JOIN CTE1 ON CTE1.artist_id = albm2.artist_id
GROUP BY 1,2,3,4
...
WITH CTE1 AS
(
	SELECT c.country, g.genre_id, g.name, COUNT(il.quantity) AS total_purchases,
